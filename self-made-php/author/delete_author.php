        ...
        <h1>作者一覧</h1>
            ...
            <?php while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) { ?>
                <tr>
                    ...
                    <td>
                        <?php
                        $img_url = "http://52.54.93.120/img/author/";
            ...
            <?php } ?>
                ...
                <?php
                    session_start();
                    if(! empty($_SESSION['delete_author'])){
                        echo("<br>".$_SESSION['delete_author']."<br>");
...
<?php
    ...
    if (! empty($id)) {
        ...
        try {
            ...
            unlink('/var/www/html/img/author/' . $img['image']);
            ...
            $stmt->execute();
            session_start();
            $_SESSION['delete_author']="削除完了";
            unset($_GET['id']);
            echo '<script type="text/javascript">window.location.href = window.location.hreg = "http://52.54.93.120/authors/delete";</script>';
            exit();
